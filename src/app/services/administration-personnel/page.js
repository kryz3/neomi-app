...
export const metadata = {
  title: "Administration du Personnel - Neomi",
  description: "Des dossiers salariés complets et conformes",
};

export default function AdministrationPersonnel() {
  return (
      ...
      <div className="relative z-10 pt-8 pb-4">
        <div className="container mx-auto px-6">
          <nav className="text-sm text-gray-600 mb-4">
            ...
            <span className="text-accent font-medium">Administration du Personnel</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 font-medium">
              Des dossiers salariés complets et conformes.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-accent/10 mb-8">
            ...
            <div className="space-y-4">
              {[
                "DPAE, entrées/sorties, attestations",
                "Suivi absences/congés, mutuelle/prévoyance", 
                "Documents standards (règlement intérieur, notes)"
              ].map((item, i) => (
          ...
          <div className="text-center">
            ...
            >
              Organiser mes dossiers du personnel
