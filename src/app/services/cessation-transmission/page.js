...
export const metadata = {
  title: "Cessation/Transmission - Neomi",
  description: "Préparer et réussir la transmission de son entreprise",
};

export default function CessationTransmission() {
  return (
      ...
      <div className="relative z-10 pt-8 pb-4">
        <div className="container mx-auto px-6">
          <nav className="text-sm text-gray-600 mb-4">
            ...
            <span className="text-secondary font-medium">Cessation/Transmission</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 font-medium">
              Préparer et réussir la transmission de son entreprise.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-secondary/10 mb-8">
            ...
            <div className="space-y-4">
              {[
                "Diagnostic pré-transmission (valorisation, audit)",
                "Stratégie de transmission (familiale, externe, management)",
                "Optimisation fiscale de la cession", 
                "Négociation & accompagnement juridique",
                "Plan de reconversion du dirigeant",
                "Gestion post-cession (investissement des fonds)"
              ].map((item, i) => (
