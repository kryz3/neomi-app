...
export const metadata = {
  title: "Comptabilité & Bilans - Neomi",
  description: "Produire des comptes fiables pour décider vite et en sécurité",
};

export default function ComptabiliteBilans() {
  return (
      ...
      <div className="relative z-10 pt-8 pb-4">
        <div className="container mx-auto px-6">
          <nav className="text-sm text-gray-600 mb-4">
            ...
            <span className="text-primary font-medium">Comptabilité & Bilans</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 font-medium">
              Produire des comptes fiables pour décider vite et en sécurité.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-primary/10 mb-8">
            ...
            <div className="space-y-4">
              {[
                "Tenue, révision, situations intermédiaires",
                "Comptes annuels & annexes, dossier de gestion", 
                "Reporting synthétique (marge, trésorerie, seuils)",
                "Assistance contrôle (option)"
              ].map((item, i) => (
