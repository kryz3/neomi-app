...
export const metadata = {
  title: "Croissance & Pilotage - Neomi",
  description: "Piloter par les chiffres et anticiper",
};

export default function CroissancePilotage() {
  return (
      ...
      <div className="relative z-10 pt-8 pb-4">
        <div className="container mx-auto px-6">
          <nav className="text-sm text-gray-600 mb-4">
            ...
            <span className="text-secondary font-medium">Croissance & Pilotage</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 font-medium">
              Piloter par les chiffres et anticiper.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-secondary/10 mb-8">
            ...
            <div className="space-y-4">
              {[
                "Tableaux de bord, budget, prévisionnel",
                "Plan de trésorerie & alertes", 
                "Comités de pilotage (mensuel/trimestriel)"
              ].map((item, i) => (
