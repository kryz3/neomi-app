...
export const metadata = {
  title: "Financement - Neomi",
  description: "Trouver de la ressource et sécuriser son activité",
};
      ...
      <div className="relative z-10 pt-8 pb-4">
        <div className="container mx-auto px-6">
          <nav className="text-sm text-gray-600 mb-4">
            ...
            <span className="text-secondary font-medium">Financement</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 font-medium">
              Trouver de la ressource et sécuriser son activité.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-secondary/10 mb-8">
            ...
            <div className="space-y-4">
              {[
                "Recherche & monlage de dossiers de financement",
                "Business Plan",
                "Négociation bancaire / accompagnement RV banque", 
                "Suivi budgétaire & reportings"
              ].map((item, i) => (
