...
export const metadata = {
  title: "Juridique Courant - Neomi",
  description: "Sécuriser la vie sociale de la société",
};

export default function JuridiqueCourant() {
  return (
      ...
      <div className="relative z-10 pt-8 pb-4">
        <div className="container mx-auto px-6">
          <nav className="text-sm text-gray-600 mb-4">
            ...
            <span className="text-primary font-medium">Juridique Courant</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 font-medium">
              Sécuriser la vie sociale de la société.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-primary/10 mb-8">
            ...
            <div className="space-y-4">
              {[
                "AGO annuelle, rapports, PV, dépôts",
                "Modifications statutaires (siège, gérance, capital…)", 
                "Conventions intragroupe, registres obligatoires"
              ].map((item, i) => (
