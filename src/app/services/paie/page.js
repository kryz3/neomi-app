...
export const metadata = {
  title: "Paie - Neomi",
  description: "Paie juste, délais tenus, DSN fiables",
};
      ...
      <div className="relative z-10 pt-8 pb-4">
        <div className="container mx-auto px-6">
          <nav className="text-sm text-gray-600 mb-4">
            ...
            <span className="text-accent font-medium">Paie</span>
          </nav>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-700 font-medium">
              Paie juste, délais tenus, DSN fiables.
            </p>
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-xl border border-accent/10 mb-8">
            ...
            <div className="space-y-4">
              {[
                "Bulletins, DSN, soldes de tout compte",
                "Contrôles & synthèses mensuelles", 
                "Assistance URSSAF (questions/échanges)"
              ].map((item, i) => (
